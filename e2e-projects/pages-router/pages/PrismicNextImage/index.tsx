...
export default function Page({
	...
	return (
		<>
			...
			<PrismicNextImage data-testid="explicit-width" field={tests.filled} width={400} />
			<PrismicNextImage data-testid="explicit-height" field={tests.filled} height={300} />
			<PrismicNextImage
			...
			<PrismicNextImage data-testid="quality" field={tests.filled} quality={10} />

			<PrismicNextImage data-testid="with-alt" field={tests.with_alt_text} />
			<PrismicNextImage data-testid="without-alt" field={tests.without_alt_text} />
			<PrismicNextImage
				data-testid="with-decorative-fallback-alt"
				field={tests.without_alt_text}
				fallbackAlt=""
			/>
			<PrismicNextImage data-testid="with-decorative-alt" field={tests.without_alt_text} alt="" />

			<PrismicNextImage data-testid="fill" field={tests.filled} fill />

			<PrismicNextImage data-testid="imgix" field={tests.filled} imgixParams={{ sat: -100 }} />
			<PrismicNextImage
			...
			<PrismicNextImage data-testid="default-loader" field={tests.filled} loader={null} />
			<PrismicNextImage
