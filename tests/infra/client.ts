...
export class Repo {
	...
	async #waitForPreviewVersion(document: CoreAPIDocument): Promise<CoreAPIDocument> {
		...
		while (Date.now() < deadline) {
			...
			await new Promise((resolve) => setTimeout(resolve, DOCUMENT_VERSION_POLL_INTERVAL))
		}
